...
const regex = /<!-- Timeline Layout -->[\s\S]*?(?=<!-- Section: Quotes -->)/;
const match = content.match(regex);
if (match) {
    const updatedContent = content.replace(regex, newLayout + "\n                    ");
    fs.writeFileSync(file, updatedContent);
    console.log("Successfully replaced timeline layout!");
} else {
    console.log("Could not find timeline layout block.");
}
